...
<div class="page-title-container">
    <div class="container">
        <div class="page-title pull-left">
            <h2 class="entry-title">Translado - Criar</h2>
        </div>
    </div>
</div>
@stop
...
{{Form::open(array('url' => array("admin/translado"), 'method' => 'POST', 'files' => true))}}
		...
		<div class="block">
		    ...
		    <div class="tab-container trans-style box">
		        <ul class="tabs full-width">
		            ...
		            <li class=""><a href="#fourth-tab" data-toggle="tab"><i class="soap-icon-suitcase circle"></i>Preços</a></li>
		        ...
		        <div class="tab-content">
		            ...
		            <div class="tab-pane fade" id="fourth-tab">
		                ...
		                <div class="form-group">
		                    <span id="div_valor_diaria"><label for="valor_diaria" class="">Valor por Adulto</label>
		                    {{Form::text('valor_adulto', null, array('class' => 'form-control', 'id' => 'valor_adulto'))}}
		                    </span>
		                </div>
		                <div class="form-group">
		                    <span id="div_deposito"><label for="deposito" class="">Valor por Criança</label>
		                    {{Form::text('valor_crianca', null, array('class' => 'form-control', 'id' => 'valor_crianca'))}}
		                    </span>
		                </div>
		            </div>
		            <!-- <div class="tab-pane fade" id="fourth-tab">
