...
<div class="page-title-container">
    <div class="container">
        <div class="page-title pull-left">
            <h2 class="entry-title">Passeios - Editando "{{$passeio->nome_br}}"</h2>
        </div>
    </div>
</div>
@stop
...
{{Form::model($passeio, array('url' => array("admin/passeio", $passeio->id), 'method' => 'PUT', 'files' => true))}}
		<div class="btn-toolbar" role="toolbar">
		    <div class="pull-left">
		    	<h2></h2>
			</div>
		    <div class="pull-right">
			    <a href="http://funworldtours.dev/admin/passeio" class="btn btn-default">Voltar para listagem</a>
			    <button type="submit" class="btn btn-success">Salvar</button>
		    </div>
	    </div>
		<div class="block">
			<img id="img" src="@if($passeio->imagem) uploads/passeios/{{$passeio->imagem}} @else images/no-img.png @endif" alt="" width="570" height="300" style="width: 100%; cursor: pointer;">
		               ...
		               <div class="form-group">
		                ...
		                <div class="form-group">
		                    <span id="div_pais_id">
		                        ...
		                        {{Form::select('tipo', array('Esportes' => 'Esportes', 'Trilhas' => 'Trilhas'), null, array('class' => 'form-control', 'id' => 'tipo'))}}
		                    </span>
		                </div>
...
<script type="text/javascript">
	...
	$(document).ready(function()
	{
		...
		@if($passeio->imagens->count() > 1)
			var i = {{$passeio->imagens->count()}}
		@else
			var i = 1;
		@endif
