...
<div class="page-title-container">
    <div class="container">
        <div class="page-title pull-left">
            <h2 class="entry-title">Serviço Noturno - Editando "{{$serviconoturno->nome_br}}"</h2>
        </div>
    </div>
</div>
@stop
...
{{Form::model($serviconoturno, array('url' => array("admin/serviconoturno", $serviconoturno->id), 'method' => 'PUT', 'files' => true))}}
		<div class="btn-toolbar" role="toolbar">
		    <div class="pull-left">
		    	<h2></h2>
			</div>
		    <div class="pull-right">
			    <a href="http://funworldtours.dev/admin/serviconoturno" class="btn btn-default">Voltar para listagem</a>
			    <button type="submit" class="btn btn-success">Salvar</button>
		    </div>
	    </div>
		<div class="block">
			<img id="img" src="@if($serviconoturno->imagem) uploads/servicosnoturnos/{{$serviconoturno->imagem}} @else images/no-img.png @endif" alt="" width="570" height="300" style="width: 100%; cursor: pointer;">
		        ...
		        <div class="tab-content">
		            ...
		            <div class="tab-pane fade" id="third-tab">
		               ...
		               <div class="form-group">
		                ...
		                <div id="boate" style="display: none;">
			                <div class="form-group col-md-6">
			                	<span id="div_nome_en"><label for="nome_en" class=" required">Preço Masculino</label>
			                	{{Form::text('valor_masculino', null, array('class' => 'form-control', 'id' => 'valor_masculino'))}}
			                </div>

			                <div class="form-group col-md-6">
			                	<span id="div_nome_en"><label for="nome_en" class=" required">Preço Masculino MEIA</label>
			                	{{Form::text('valor_masculino_meia', null, array('class' => 'form-control', 'id' => 'valor_masculino'))}}
			                </div>

			                <div class="form-group col-md-6">
			                	<span id="div_nome_en"><label for="nome_en" class=" required">Preço Feminino</label>
			                	{{Form::text('valor_feminino', null, array('class' => 'form-control', 'id' => 'valor_feminino'))}}
			                </div>

			                <div class="form-group col-md-6">
			                	<span id="div_nome_en"><label for="nome_en" class=" required">Preço Feminino MEIA</label>
			                	{{Form::text('valor_feminino_meia', null, array('class' => 'form-control', 'id' => 'valor_feminino'))}}
			                </div>
...
<script type="text/javascript">
	...
	$(document).ready(function()
	{
		...
		@if($serviconoturno->imagens->count() > 1)
			var i = {{$serviconoturno->imagens->count()}}
		@else
			var i = 1;
		@endif
