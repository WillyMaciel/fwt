        ...
        <section id="content">
            <div class="container">
                <div id="main">
                    ...
                    <div class="text-center yellow-color box" style="font-size: 4em; font-weight: 300; line-height: 1em;">{{trans('auth.register_welcome')}}</div>
                    <p class="light-blue-color block" style="font-size: 1.3333em;">{{trans('auth.please_register')}}</p>
