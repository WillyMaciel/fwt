        ...
        <div class="revolution-slider" style="height: 0; overflow: hidden;">
            <ul>    <!-- SLIDE  -->
                ...
                <li data-transition="zoomin" data-slotamount="7" data-masterspeed="1500">
                    <!-- MAIN IMAGE -->
                    <img src="images/slider/rio.jpg" alt="">
                </li>
                
                <!-- Slide2 -->
                <li data-transition="zoomout" data-slotamount="7" data-masterspeed="1500">
                    <!-- MAIN IMAGE -->
                    <img src="images/slider/newyork.jpg" alt="">
                </li>
            </ul>
        </div>
    </div>
        ...
        <div class="search-box container">
            ...
            <div class="search-tab-content">
                <div class="tab-pane fade active in" id="hotels-tab">
                    ...
                    <!-- FORM DE HOTEIS -->
                    <form action="{{URL::to('hotel/')}}" method="get">
                        <div class="row">
                            <div class="form-group col-sm-6 col-md-3">
                                <h4 class="title">Where</h4>
                                <label>Your Destination</label>
                                <input name="destino" id="destino" type="text" class="input-text full-width destino" placeholder="enter a destination, Ex: Rio de Janeiro" />
                            </div>
