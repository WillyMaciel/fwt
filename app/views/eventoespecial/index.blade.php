...
<div class="page-title-container">
    <div class="container">
        <div class="page-title pull-left">
            <h2 class="entry-title">{{trans('menu.eventos_especiais')}}</h2>
        </div>
    </div>
</div>
@stop
                ...
                <div class="toggle-container filters-container">
                    ...
                    <div class="panel style1 arrow-right">
                        ...
                        <div id="modify-search-panel" class="panel-collapse collapse">
                            <div class="panel-content">
                                <form method="get" action="{{URL::to('eventoespecial/')}}">
                    ...
                    @foreach($eventos as $evento)
                        <article class="box">
                            <figure class="col-sm-5 col-md-4">
                                <a title="" href="{{URL::to("eventoespecial/show/{$evento->id}")}}" class="hover-effect"><img width="270" height="160" alt="" src="@if(isset($evento->imagem)) uploads/eventosespeciais/270x160_{{$evento->imagem}} @else http://placehold.it/270x160 @endif"></a>
                            </figure>
                            <div class="details col-sm-7 col-md-8">
                                ...
                                <div>
                                    ...
                                    <div>
                                        ...
                                        <a class="button btn-small full-width text-center" title="" href="{{URL::to("eventoespecial/show/{$evento->id}")}}">{{trans('hotel.selecionar')}}</a>
                                    </div>
                                </div>
                            </div>
                        </article>
