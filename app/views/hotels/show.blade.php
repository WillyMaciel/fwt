                ...
                <div class="tab-content">
                    <div id="photos-tab" class="tab-pane fade in active">
                        <div class="photo-gallery style1" data-animation="slide" data-sync="#photos-tab .image-carousel">
                            <ul class="slides">
                                <li><img src="@if($hotel->imagem) uploads/hoteis/900x500_{{$hotel->imagem}} @else http://placehold.it/900x500}} @endif" alt="" /></li>
...
We suggest that you contact the host to confirm availability and rates before submitting a reservation request.
                ...
                <div class="tab-content">
                    <div class="tab-pane fade in active" id="hotel-description">
                        <div class="long-description">
                            <h2>@if(Session::get('lang') == 'pt') Sobre {{$hotel->nome_br}} @else About {{$hotel->nome_en}} @endif</h2>
                            <p>@if(Session::get('lang') == 'pt') {{$hotel->descricao_br}} @else {{$hotel->descricao_en}} @endif</p>
                        </div>
                    </div>
                    ...
                    <div class="tab-pane fade" id="hotel-amenities">
                        ...
                        @if(count($hotel->caracteristicas) > 0)
                    ...
                    <div class="tab-pane fade" id="hotel-write-review">
                        @include('forms.review', array('action' => URL::to('review'), 'produto_id' => $hotel->id))
                    </div>
                </div>
        ...
        <div class="sidebar col-md-3">
            <article class="detailed-logo">
                <figure>
                    <img width="114" height="85" src=" @if($hotel->imagem) uploads/hoteis/114x85_{{$hotel->imagem}} @else http://placehold.it/114x85 @endif" alt="">
                </figure>
                <div class="details">
                    <h2 class="box-title">@if(Session::get('lang') == 'pt') {{$hotel->nome_br}} @else {{$hotel->nome_en}} @endif<small><i class="soap-icon-departure yellow-color"></i><span class="fourty-space">@if(Session::get('lang') == 'pt') {{$hotel->pais->name}} @else {{$hotel->pais->name}} @endif</span></small></h2>
                    ...
                    <p class="description">@if(Session::get('lang') == 'pt') {{substr($hotel->descricao_br, 0, 150) . ' ...'}} @else {{substr($hotel->descricao_en, 0, 150) . ' ...'}} @endif</p>
                        <!-- CARRINHO -->
