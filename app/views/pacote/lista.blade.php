...
<div class="page-title-container">
    <div class="container">
        <div class="page-title pull-left">
            <h2 class="entry-title">{{trans('menu.pacotes')}} - {{$continente->name_en}}</h2>
        </div>
    </div>
</div>
@stop
                            ...
                            <div class="panel-content">
                                <form method="get" action="{{URL::to('pacote/paises')}}">
                                    <div class="form-group">
                                        ...
                                        <input name="continente" type="text" class="input-text full-width destino" placeholder="Ex: América do Sul" value="" />
                                    </div>
                                    <!-- <div class="form-group">
