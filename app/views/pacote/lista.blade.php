...
<div class="page-title-container">
    <div class="container">
        <div class="page-title pull-left">
            <h2 class="entry-title"><a href="{{URL::to('pacote/continentes')}}">{{trans('menu.destinos')}}</a> / {{$continente->name_en}}</h2>
        </div>
    </div>
</div>
@stop
                    ...
                    <div class="panel style1 arrow-right">
                        ...
                        <div id="modify-search-panel" class="panel-collapse collapse">
                            <div class="panel-content">
                                <form method="get" action="{{URL::to('pacote/paises')}}">
                                    ...
                                    <br />
                                    <button class="btn-medium icon-check uppercase full-width">{{trans('formulario.busca')}}</button>
                                </form>
                            </div>
                        </div>
                    </div>
                	...
                	<div class="hotel-list">
                                ...
                                @foreach($paises as $p)
                                    <div class="col-sms-6 col-sm-6 col-md-4">
                                        <article class="box">
                                            <figure>
                                                <a href="{{URL::to("pacote/?continente={$p->continente->name_pt}&pais={$p->id}")}}" title="" class="hover-effect"><img src="{{$p->imagem or 'http://placehold.it/270x160'}}" alt="" width="270" height="160" style="width: 260px; height: 160px;" /></a>
                                            </figure>
                                            <div class="details">
