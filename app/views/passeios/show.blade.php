                ...
                <div class="tab-content">
                    <div id="photos-tab" class="tab-pane fade in active">
                        <div class="photo-gallery style1" data-animation="slide" data-sync="#photos-tab .image-carousel">
                            <ul class="slides">
                                <li><img src="@if($passeio->imagem) uploads/passeios/900x500_{{$passeio->imagem}} @else http://placehold.it/900x500}} @endif" alt="" /></li>
                                @foreach($passeio->imagens as $img)
...
We suggest that you contact the host to confirm availability and rates before submitting a reservation request.
                ...
                <div class="tab-content">
                    <div class="tab-pane fade in active" id="hotel-description">
                        <div class="long-description">
                            <h2>@if(Session::get('lang') == 'pt') Sobre {{$passeio->nome_br}} @else About {{$passeio->nome_en}} @endif</h2>
                            <p>@if(Session::get('lang') == 'pt') {{$passeio->descricao_br}} @else {{$passeio->descricao_en}} @endif</p>
                        </div>
                    </div>
                    ...
                    <div class="tab-pane fade" id="hotel-reviews">
                        @if(!$passeio->reviews->isEmpty())
                        <div class="guest-reviews">
                            <h2>Guest Reviews</h2>
                            @foreach($passeio->reviews as $review)
                    ...
                    <div class="tab-pane fade" id="hotel-write-review">
                        @include('forms.review', array('action' => URL::to('review'), 'produto_id' => $passeio->id))
                    </div>
                </div>
        ...
        <div class="sidebar col-md-3">
            <article class="detailed-logo">
                <figure>
                    <img width="114" height="85" src=" @if($passeio->imagem) uploads/passeios/114x85_{{$passeio->imagem}} @else http://placehold.it/114x85 @endif" alt="">
                </figure>
                <div class="details">
                    <h2 class="box-title">@if(Session::get('lang') == 'pt') {{$passeio->nome_br}} @else {{$passeio->nome_en}} @endif<small><i class="soap-icon-departure yellow-color"></i><span class="fourty-space">@if(Session::get('lang') == 'pt') {{$passeio->pais->name}} @else {{$passeio->pais->name}} @endif</span></small></h2>
                    <span class="price clearfix">
                        <small class="pull-left">{{trans('carrinho.preco')}}</small>
                        <span class="pull-right">{{$passeio->valor or '--'}}</span>
                    </span>
                    <div class="feedback clearfix">
                        <div title="" class="five-stars-container" data-toggle="tooltip" data-placement="bottom" data-original-title="{{$passeio->estrelas or 0}} {{trans('hotel.estrelas')}}">
